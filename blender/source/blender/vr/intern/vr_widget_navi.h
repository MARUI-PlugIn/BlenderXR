...
public:
  static VR_UI::NavLock nav_lock[3];	/* The current navigation locks (if any). */
	...
	{
    static bool elevation_change; /* Whether the grabair navi widget is in "elevation change" mode.*/
	public:
  ...
  class Joystick : public VR_Widget
  {
    ...
    static float move_speed_directional;	/* Speed multiplier for directional movement / translation. */
    static float turn_speed_directional;	/* Speed multiplier for directional turning around / rotation. */
  public:
	...
	{
		static Mat44f marker;	/* Transformation matrix of the teleport marker (rotation set to identity). */
