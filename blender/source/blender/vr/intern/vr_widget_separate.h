...
/** \file blender/vr/intern/vr_widget_separate.h
*   \ingroup vr
*/

#ifndef __VR_WIDGET_SEPARATE_H__
#define __VR_WIDGET_SEPARATE_H__

#include "vr_widget.h"

/* Interaction widget for performing a 'separate' operation. */
class Widget_Separate : public VR_Widget
{
public:
	static int mode;	/* The mode for the "separate" operation. */

	static Widget_Separate obj;	/* Singleton implementation object. */
	virtual std::string name() override { return "SEPARATE"; };	/* Get the name of this widget. */
	virtual Type type() override { return TYPE_SEPARATE; };	/* Type of Widget. */
...
#endif /* __VR_WIDGET_SEPARATE_H__ */
