...
/** \file blender/vr/intern/vr_widget_bevel.h
*   \ingroup vr
*/

#ifndef __VR_WIDGET_BEVEL_H__
#define __VR_WIDGET_BEVEL_H__

#include "vr_widget.h"

/* Interaction widget for the Bevel tool. */
class Widget_Bevel : public VR_Widget
{
...
public:
	...
	static int segments;	/* The number of bevel segments to perform. */
	static bool vertex_only;	/* Whether to perform a "vertex-only" bevel. */

	static Widget_Bevel obj;	/* Singleton implementation object. */
	virtual std::string name() override { return "BEVEL"; };	/* Get the name of this widget. */
	virtual Type type() override { return TYPE_BEVEL; };	/* Type of Widget. */
