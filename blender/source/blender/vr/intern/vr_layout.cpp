...
/** \file blender/vr/intern/vr_layout.h
*   \ingroup vr
*
...
#include "vr_layout.h"
  ...
  *
  **************************************************************************************************/
Coord3Df VR_Layout::button_positions[VR_DEVICE_TYPES][VR_SIDES][BUTTONIDS] =
{
	/*******************************************
	*			 VR_DEVICE_TYPE_NULL		   *
	********************************************/
	...
	********************************************/
	{
		/* VR_SIDE_LEFT */
		{
			...
			,
			Coord3Df(-0.001f, -0.048f, 0.012f) // BUTTONID_STICKDOWN
			,
			Coord3Df(-0.002f, -0.038f, 0.014f) // BUTTONID_STICK
			,
		...
		/* VR_SIDE_RIGHT */
		{
			...
			,
			Coord3Df(0.002f, -0.048f, 0.012f) // BUTTONID_STICKDOWN
			,
			Coord3Df(0.0015f, -0.038f, 0.014f) // BUTTONID_STICK
			,
			Coord3Df(-0.027f, -0.045f, 0.001f) // BUTTONID_THUMBREST
			,
			Coord3Df(-0.011f, -0.050f, 0.002f) // BUTTONID_XA
	...
	********************************************/
	{
		/* VR_SIDE_LEFT */
		{
			...
			,
			Coord3Df(0, -0.109f, 0.011f) //BUTTONID_DPAD
			,
			Coord3Df(0, 0, 0) // BUTTONID_STICKLEFT
			,
			Coord3Df(0, 0, 0) // BUTTONID_STICKRIGHT
	...
	********************************************/
	{
		/* VR_SIDE_LEFT */
		{
			Coord3Df(0.020f, -0.007f, 0.001f) // BUTTONID_TRIGGER
			,
			Coord3Df(0.027f, -0.114f, -0.004f) // BUTTONID_GRIP
			,
			Coord3Df(0, 0, 0) // BUTTONID_DPADLEFT
			,
			Coord3Df(0, 0, 0) // BUTTONID_DPADRIGHT
			,
			Coord3Df(0.006f, -0.040f, 0.004f) // BUTTONID_DPADUP
			,
			Coord3Df(-0.002f, -0.055f, 0.010f) // BUTTONID_DPADDOWN
			,
			Coord3Df(0, 0, 0) //BUTTONID_DPAD
			,
			Coord3Df(-0.026f, -0.040f, 0.008f) // BUTTONID_STICKLEFT
			,
			Coord3Df(-0.001f, -0.040f, 0.008f) // BUTTONID_STICKRIGHT
			,
			Coord3Df(-0.013f, -0.028f, 0.004f) // BUTTONID_STICKUP
			,
			Coord3Df(-0.013f, -0.054f, 0.012f) // BUTTONID_STICKDOWN
			,
			Coord3Df(-0.014f, -0.039f, 0.010f) // BUTTONID_STICK
			,
			Coord3Df(0, 0, 0) // BUTTONID_THUMBREST
			,
			Coord3Df(0.017f, -0.057f, 0.012f) // BUTTONID_XA
			,
			Coord3Df(0.020f, -0.045f, 0.010f) // BUTTONID_YB
			,
			Coord3Df(0, 0, 0) // BUTTONID_MENU
			,
			Coord3Df(0.008f, -0.067f, 0.014f) // BUTTONID_SYSTEM
		}
		,
		/* VR_SIDE_RIGHT */
		{
			...
			Coord3Df(0, 0, 0) // BUTTONID_DPAD
			,
			Coord3Df(0.001f, -0.040f, 0.008f) // BUTTONID_STICKLEFT
			,
			Coord3Df(0.026f, -0.040f, 0.008f) // BUTTONID_STICKRIGHT
			,
			Coord3Df(0.013f, -0.028f, 0.004f) // BUTTONID_STICKUP
			,
			Coord3Df(0.013f, -0.054f, 0.012f) // BUTTONID_STICKDOWN
	...
	,
	/*******************************************
	*			VR_DEVICE_TYPE_MAGICLEAP	   *
	********************************************/
	{
		/* VR_SIDE_LEFT */
		{
			Coord3Df(0.025f, -0.055f, 0.005f) // BUTTONID_TRIGGER
			,
			Coord3Df(0.025f, -0.035f, 0.005f) /*Coord3Df(0, 0, 0)*/ // BUTTONID_GRIP
			,
			Coord3Df(-0.016f, -0.06f, 0.005f) // BUTTONID_DPADLEFT
			,
			Coord3Df(0.016f, -0.06f, 0.005f) // BUTTONID_DPADRIGHT
			,
			Coord3Df(0, -0.044f, 0.009f) // BUTTONID_DPADUP
			,
			Coord3Df(0, -0.076f, 0.001f) // BUTTONID_DPADDOWN
			,
			Coord3Df(0, -0.06f, 0.008f) //BUTTONID_DPAD
			,
			Coord3Df(0, 0, 0) // BUTTONID_STICKLEFT
			,
			Coord3Df(0, 0, 0) // BUTTONID_STICKRIGHT
			...
			Coord3Df(0, 0, 0) // BUTTONID_YB
			,
			Coord3Df(0, -0.09f, -0.001f) // BUTTONID_MENU
			,
			Coord3Df(0, 0, 0) // BUTTONID_SYSTEM
		}
		,
		/* VR_SIDE_RIGHT */
		{
			...
			Coord3Df(0, -0.076f, 0.001f) // BUTTONID_DPADDOWN
			,
			Coord3Df(0, -0.06f, 0.005f) //BUTTONID_DPAD
			,
			Coord3Df(0, 0, 0) // BUTTONID_STICKLEFT
			,
			Coord3Df(0, 0, 0) // BUTTONID_STICKRIGHT
...
const VR_Layout::Layout VR_Layout::default_layouts[VR_DEVICE_TYPES]
{
	/********************************************
	*			VR_DEVICE_TYPE_NULL				*
	********************************************/
	...
	VR_DEVICE_TYPE_NULL
	,
	/* VR_Widget* m[VR_SIDES][BUTTONIDS] */
	{
	/* VR_SIDE_LEFT */
	{
		// BUTTONID_TRIGGER
	...
	,
	/* ButtonBit ctrl_button_bits[VR_SIDES] */
	{
		/* VR_SIDE_LEFT */
		BUTTONBIT_NONE
		,
	...
	,
	/* ButtonBit shift_button_bits[VR_SIDES] */
	{
		/* VR_SIDE_LEFT */
		BUTTONBIT_NONE
		,
	...
	********************************************/
	...
	/* VR_SIDE_LEFT */
	{
		...
		,
		// BUTTONID_STICKDOWN
		VR_Widget::get_widget(VR_Widget::TYPE_MENU_LEFT)
		,
		// BUTTONID_STICK
	...
	{
		// BUTTONID_TRIGGER
		VR_Widget::get_widget(VR_Widget::TYPE_TRANSFORM)
		,
		// BUTTONID_GRIP
		VR_Widget::get_widget(VR_Widget::TYPE_NAVI)
		,
		...
		,
		// BUTTONID_STICKDOWN
		VR_Widget::get_widget(VR_Widget::TYPE_MENU_RIGHT)
		,
		// BUTTONID_STICK
		...
		,
		// BUTTONID_XA
		VR_Widget::get_widget(VR_Widget::TYPE_CTRL)
		,
		// BUTTONID_YB
...
VR_Layout::Layout* VR_Layout::current_layout(0);
std::vector<VR_Layout::Layout*> VR_Layout::layouts[VR_DEVICE_TYPES];

VR_Layout::ButtonID VR_Layout::buttonBitToID(ButtonBit bit)
{
...
VR_Layout::ButtonBit VR_Layout::buttonIDToBit(ButtonID id)
{
	switch (id) {
...
std::string VR_Layout::buttonIDToString(ButtonID  id)
{
	switch (id) {
	case BUTTONID_TRIGGER:
		return "TRIGGER";
...
VR_Layout::ButtonID VR_Layout::buttonStringToID(const std::string  str)
{
	ButtonID btn;
	if (str == "TRIGGER") {
...
VR_Layout::~VR_Layout()
{
	...
	for (int i = 0; i < VR_DEVICE_TYPES; ++i) {
...
VR_UI::Error VR_Layout::reset_to_default_layouts()
{
	VR_UI* ui = VR_UI::i();
	if (!ui) {
	...
	map->type = (VR_Device_Type)type;
	*map = default_layouts[type];
...
VR_UI::Error VR_Layout::get_current_layout(std::string& layout)
{
	if (!current_layout) {
		return VR_UI::ERROR_INTERNALFAILURE;
	}
...
VR_UI::Error VR_Layout::set_current_layout(const std::string& layout_name)
{
	VR_UI* ui = VR_UI::i();
	if (!ui) {
		return VR_UI::ERROR_INTERNALFAILURE;
...
VR_UI::Error VR_Layout::rename_current_layout(const std::string& new_name)
{
	if (!current_layout) {
		return VR_UI::ERROR_INVALIDPARAMETER;
	}
...
VR_UI::Error VR_Layout::delete_current_layout()
{
	if (!current_layout) {
		return VR_UI::ERROR_INVALIDPARAMETER;
	}
...
VR_UI::Error VR_Layout::get_layouts_list(std::vector<std::string>& list)
{
	VR_UI* ui = VR_UI::i();
	if (!ui) {
		return VR_UI::ERROR_INTERNALFAILURE;
...
VR_UI::Error VR_Layout::map_widget(VR_Side side, std::string event, std::string widget)
{
	if (!current_layout) {
		return VR_UI::ERROR_INVALIDPARAMETER;
	}
	...
	/* If prior mapping was ctrl, shift, or alt, remove it from the ctrl/shift/alt-bits */
	if (current_layout->m[side][btn] == VR_Widget::get_widget(VR_Widget::TYPE_CTRL)) {
		ButtonBit bit = buttonIDToBit(btn);
		current_layout->ctrl_button_bits[side] = ButtonBit(current_layout->ctrl_button_bits[side] & (~bit));
	}
	if (current_layout->m[side][btn] == VR_Widget::get_widget(VR_Widget::TYPE_SHIFT)) {
		ButtonBit bit = buttonIDToBit(btn);
		current_layout->shift_button_bits[side] = ButtonBit(current_layout->shift_button_bits[side] & (~bit));
	}
	if (current_layout->m[side][btn] == VR_Widget::get_widget(VR_Widget::TYPE_ALT)) {
		ButtonBit bit = buttonIDToBit(btn);
		current_layout->alt_button_bits[side] = ButtonBit(current_layout->alt_button_bits[side] & (~bit));
	}
	/* If the new mapping is ctrl, shift, or alt, add it to the ctrl/shift/alt-bits */
	if (m == VR_Widget::get_widget(VR_Widget::TYPE_CTRL)) {
		ButtonBit bit = buttonIDToBit(btn);
		current_layout->ctrl_button_bits[side] = ButtonBit(current_layout->ctrl_button_bits[side] | bit);
	}
	...
	current_layout->m[side][btn] = m;

	return VR_UI::ERROR_NONE;
}

VR_UI::Error VR_Layout::unmap_widget(const std::string& widget)
{
	VR_UI* ui = VR_UI::i();
	if (!ui) {
		return VR_UI::ERROR_INTERNALFAILURE;
	...
	for (auto it = layouts[type].begin(); it != layouts[type].end(); ++it) {
		for (int side = 0; side < 2; ++side) {
			for (int button = 0; button < BUTTONIDS; ++button) {
				if ((*it) && (*it)->m[side][button] == w) {
					(*it)->m[side][button] = 0; /* unmap */
				}
			}
		}
	}
...
VR_UI::Error VR_Layout::get_mapped_widget(VR_Side side, const std::string& event, std::string& widget)
{
	if (!current_layout) {
		widget = "";
	...
	VR_Widget* w = current_layout->m[side][btn];
...
VR_UI::Error VR_Layout::get_mapped_event(const std::string& widget, VR_Side& side, std::string& event)
{
	return get_mapped_event(current_layout, widget, side, event);
}

VR_UI::Error VR_Layout::get_mapped_event(const VR_Widget* widget, VR_Side& side, std::string& event)
{
	return get_mapped_event(current_layout, widget, side, event);
}

VR_UI::Error VR_Layout::get_mapped_event(const Layout* layout, const std::string& widget, VR_Side& side, std::string& event)
{
	return get_mapped_event(layout, VR_Widget::get_widget(widget), side, event);
}

VR_UI::Error VR_Layout::get_mapped_event(const Layout* layout, const VR_Widget* widget, VR_Side& side, std::string& event)
{
	ButtonID button;

	VR_UI::Error e = get_mapped_event(layout, widget, side, button);
...
VR_UI::Error VR_Layout::get_mapped_event(const Layout* layout, const VR_Widget* widget, VR_Side& side, ButtonID& event)
{
	if (!layout || !widget) {
...
VR_UI::Error VR_Layout::get_events_list(std::vector<std::string>& events)
{
