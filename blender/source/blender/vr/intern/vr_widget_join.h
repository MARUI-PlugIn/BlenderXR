...
/** \file blender/vr/intern/vr_widget_join.h
*   \ingroup vr
*/

#ifndef __VR_WIDGET_JOIN_H__
#define __VR_WIDGET_JOIN_H__

#include "vr_widget.h"

/* Interaction widget for performing a 'join' operation. */
class Widget_Join : public VR_Widget
{
public:
	static Widget_Join obj;	/* Singleton implementation object. */
	virtual std::string name() override { return "JOIN"; };	/* Get the name of this widget. */
	virtual Type type() override { return TYPE_JOIN; };	/* Type of Widget. */
