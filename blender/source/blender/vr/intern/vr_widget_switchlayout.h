...
/** \file blender/vr/intern/vr_widget_switchlayout.h
*   \ingroup vr
*/

#ifndef __VR_WIDGET_SWITCHLAYOUT_H__
#define __VR_WIDGET_SWITCHLAYOUT_H__
...
#endif /* __VR_WIDGET_SWITCHLAYOUT_H__ */
