...
/** #UserDef.vr_device */
typedef enum VR_Device_Type {
  VR_DEVICE_TYPE_NULL = 0,
  VR_DEVICE_TYPE_OCULUS = 1,
  VR_DEVICE_TYPE_VIVE = 2,
  VR_DEVICE_TYPE_WINDOWSMR = 3,
  VR_DEVICE_TYPE_FOVE = 4,
  VR_DEVICE_TYPE_PIMAX = 5,
  VR_DEVICE_TYPE_INDEX = 6,
  VR_DEVICE_TYPE_MAGICLEAP = 7,
  VR_DEVICE_TYPES = 8
} VR_Device_Type;
